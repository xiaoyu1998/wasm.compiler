...
public:
  ...
  //xiaoyu
  bool isWasmWasmABI()const;
  std::string getWasmWasmABI()const;
  bool isWasmWasmEntry()const;
  bool isWasmWasmImport()const;
  bool isWasmWasmAction()const;
  std::string getWasmWasmAction()const;
  bool isWasmWasmNotify()const;
  std::string getWasmWasmNotify()const;
