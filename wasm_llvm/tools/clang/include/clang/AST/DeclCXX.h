...
public:
  ...
  bool isWasmAction() const { return hasAttr<WasmActionAttr>(); }
  bool isWasmTable() const { return hasAttr<WasmTableAttr>(); }
  bool isWasmIgnore() const { return hasAttr<WasmIgnoreAttr>(); }
  bool hasWasmRicardian() const { return hasAttr<WasmRicardianAttr>(); }
  WasmActionAttr* getWasmActionAttr() const { return getAttr<WasmActionAttr>(); }
  WasmTableAttr*  getWasmTableAttr() const { return getAttr<WasmTableAttr>(); }
  WasmContractAttr*  getWasmContractAttr() const { return getAttr<WasmContractAttr>(); }
  WasmRicardianAttr*  getWasmRicardianAttr() const { return getAttr<WasmRicardianAttr>(); }
...
public:
  ...
  //xiaoyu
  bool isWasmAction() const { return hasAttr<WasmActionAttr>(); }
  bool isWasmNotify() const { return hasAttr<WasmNotifyAttr>(); }
  bool isWasmContract() const { return hasAttr<WasmContractAttr>(); }
  bool hasWasmRicardian() const { return hasAttr<WasmRicardianAttr>(); }
  WasmActionAttr* getWasmActionAttr() const { return getAttr<WasmActionAttr>(); }
  WasmNotifyAttr* getWasmNotifyAttr() const { return getAttr<WasmNotifyAttr>(); }
  WasmContractAttr* getWasmContractAttr() const { return getAttr<WasmContractAttr>(); }
  WasmRicardianAttr* getWasmRicardianAttr() const { return getAttr<WasmRicardianAttr>(); }
