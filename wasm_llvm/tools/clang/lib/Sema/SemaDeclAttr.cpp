...
//xiaoyu
static void handleWasmRicardianAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  ...
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
   ...
   D->addAttr(::new (S.Context)
                 WasmRicardianAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}

static void handleWasmNotifyAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  // Handle the cases where the attribute has a text message.
  StringRef Str;
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
      !S.checkStringLiteralArgumentAttr(AL, 0, Str))
   ...
   D->addAttr(::new (S.Context)
                 WasmNotifyAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}

static void handleWasmContractAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  // Handle the cases where the attribute has a text message.
  StringRef Str;
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
      !S.checkStringLiteralArgumentAttr(AL, 0, Str))
    return;
  D->addAttr(::new (S.Context)
                 WasmContractAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}

static void handleWasmABIAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  // Handle the cases where the attribute has a text message.
  StringRef Str;
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
      !S.checkStringLiteralArgumentAttr(AL, 0, Str))
  ...
  D->addAttr(::new (S.Context)
                 WasmWasmABIAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}

static void handleWasmWasmActionAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  // Handle the cases where the attribute has a text message.
  StringRef Str;
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
      !S.checkStringLiteralArgumentAttr(AL, 0, Str))
  ...
  D->addAttr(::new (S.Context)
                 WasmWasmActionAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}

static void handleWasmWasmNotifyAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  // Handle the cases where the attribute has a text message.
  StringRef Str;
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
      !S.checkStringLiteralArgumentAttr(AL, 0, Str))
  ...
  D->addAttr(::new (S.Context)
                 WasmWasmNotifyAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}

static void handleWasmActionAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  // Handle the cases where the attribute has a text message.
  StringRef Str;
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
      !S.checkStringLiteralArgumentAttr(AL, 0, Str))
  ...
  D->addAttr(::new (S.Context)
                 WasmActionAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}

static void handleWasmTableAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  // Handle the cases where the attribute has a text message.
  StringRef Str;
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
      !S.checkStringLiteralArgumentAttr(AL, 0, Str))
  ...
  D->addAttr(::new (S.Context)
                 WasmTableAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}
...
static void ProcessDeclAttribute(Sema &S, Scope *scope, Decl *D,
  ...
  //xiaoyu
  case AttributeList::AT_WasmWasmImport:
    handleSimpleAttribute<WasmWasmImportAttr>(S, D, AL);
    break;
  case AttributeList::AT_WasmWasmEntry:
    handleSimpleAttribute<WasmWasmEntryAttr>(S, D, AL);
    break;
  case AttributeList::AT_WasmIgnore:
    handleSimpleAttribute<WasmIgnoreAttr>(S, D, AL);
    break;
  case AttributeList::AT_WasmAction:
    handleWasmActionAttribute(S, D, AL);
    break;
  case AttributeList::AT_WasmTable:
    handleWasmTableAttribute(S, D, AL);
    break;
  case AttributeList::AT_WasmWasmABI:
    handleWasmABIAttribute(S, D, AL);
    break;
  case AttributeList::AT_WasmWasmAction:
    handleWasmWasmActionAttribute(S, D, AL);
    break;
  case AttributeList::AT_WasmWasmNotify:
    handleWasmWasmNotifyAttribute(S, D, AL);
    break;
  case AttributeList::AT_WasmContract:
    handleWasmContractAttribute(S, D, AL);
    break;
  case AttributeList::AT_WasmRicardian:
    handleWasmRicardianAttribute(S, D, AL);
    break;
  case AttributeList::AT_WasmNotify:
    handleWasmNotifyAttribute(S, D, AL);
    break;
