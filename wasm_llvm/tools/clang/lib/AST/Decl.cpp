...
//xiaoyu
bool RecordDecl::isWasmIgnore() const { return hasAttr<WasmIgnoreAttr>(); }
...
bool FunctionDecl::isWasmWasmABI()const { return hasAttr<WasmWasmABIAttr>(); }
std::string FunctionDecl::getWasmWasmABI()const { return getAttr<WasmWasmABIAttr>()->getAbi(); }
bool FunctionDecl::isWasmWasmEntry()const { return hasAttr<WasmWasmEntryAttr>(); }
bool FunctionDecl::isWasmWasmImport()const { return hasAttr<WasmWasmImportAttr>(); }
bool FunctionDecl::isWasmWasmAction()const { return hasAttr<WasmWasmActionAttr>(); }
std::string FunctionDecl::getWasmWasmAction()const { return getAttr<WasmWasmActionAttr>()->getName(); }
bool FunctionDecl::isWasmWasmNotify()const { return hasAttr<WasmWasmNotifyAttr>(); }
std::string FunctionDecl::getWasmWasmNotify()const { return getAttr<WasmWasmNotifyAttr>()->getName(); }
