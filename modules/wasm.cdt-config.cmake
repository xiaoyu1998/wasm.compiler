if(WASM_CDT_ROOT STREQUAL "" OR NOT WASM_CDT_ROOT)
   set(WASM_CDT_ROOT "@CDT_ROOT_DIR@")
endif()

list(APPEND CMAKE_MODULE_PATH ${WASM_CDT_ROOT}/lib/cmake/wasm.cdt)
if (NOT WASM_WASM_OLD_BEHAVIOR STREQUAL "Off")
    set(WASM_WASM_OLD_BEHAVIOR "On")
    include(WasmWasmToolchain)
endif()
...
function(WASM_CHECK_VERSION output version hard_min soft_max hard_max) # optional 6th argument for error message
...
endfunction(WASM_CHECK_VERSION)
