...
namespace wasm {
   ...
   /**
    *  Serialize an wasm::public_key into a stream
    *
    *  @ingroup public_key
   ...
   inline DataStream& operator<<(DataStream& ds, const wasm::public_key& pubkey) {
      ds << pubkey.type;
   ...
   /**
    *  Deserialize an wasm::public_key from a stream
    *
    *  @ingroup public_key
    ...
    */
   template<typename DataStream>
   inline DataStream& operator>>(DataStream& ds, wasm::public_key& pubkey) {
      ds >> pubkey.type;
   ...
   /**
    *  Serialize an wasm::signature into a stream
    *
    *  @param ds - The stream to write
    ...
    */
   template<typename DataStream>
   inline DataStream& operator<<(DataStream& ds, const wasm::signature& sig) {
      ds << sig.type;
   ...
   /**
    *  Deserialize an wasm::signature from a stream
    *
    *  @param ds - The stream to read
    ...
    */
   template<typename DataStream>
   inline DataStream& operator>>(DataStream& ds, wasm::signature& sig) {
      ds >> sig.type;
    ...
    *  @param data - Data you want to hash
    *  @param length - Data length
    *  @return wasm::checksum256 - Computed digest
    */
    ...
    *  @param data - Data you want to hash
    *  @param length - Data length
    *  @return wasm::checksum160 - Computed digest
    */
    ...
    *  @param data - Data you want to hash
    *  @param length - Data length
    *  @return wasm::checksum512 - Computed digest
    */
    ...
    *  @param sig - Signature
    *  @return wasm::public_key - Recovered public key
    */
