...
namespace wasm {
   ...
   inline DataStream& operator<<(DataStream& ds, const ::wasm::ignore_wrapper<T>& val) {
     ds << val.value;
     return ds;
   }
    ...
    */
   template<typename DataStream, typename T>
   inline DataStream& operator<<(DataStream& ds, const ::wasm::ignore<T>& val) {
     return ds;
   }
    ...
    */
   template<typename DataStream, typename T>
   inline DataStream& operator>>(DataStream& ds, ::wasm::ignore<T>&) {
     return ds;
   }
}
